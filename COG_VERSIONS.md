...
| 2026-06-19 | `087dd9e` | `d3ec159523ec61d2578c54e217515e977851b9630bf6c5a969ef07aa17944711` | + REAL clip fix: astats float-peak measure → constant float-domain trim → s16 (pydub-safe). E2E: TRANSLATE_DE bed_lift +4.2dB, clip_peak −1.6 (was 0.0), Flat factor 0, music-below-mix 7.1dB; INSTRUMENTAL bed_lift=None (RULE #1 untouched). Founder ear-gate on Al-Pacino pending | **LIVE 2026-06-19** (prod run kww5ejjfm5 confirms) |
