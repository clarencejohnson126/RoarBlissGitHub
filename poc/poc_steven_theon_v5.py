#!/usr/bin/env python3
"""
Steven x Theon v5 — volume fix + tighter text rewrites
======================================================
Changes from v4:
  - LOUDNESS: match clone to the original slot's own dBFS (not the
    surrounding ±1.5s window which included silence and made clones quiet)
  - TEXT: rewrote 5 slots that came back too long in v4 (5, 6, 14, 18, 25)
    to be much shorter — target ~3 syl/sec more aggressively
  - Slot 14 ("I'm reborn") which triggered Qwen3 instability (102x ratio)
    replaced with a different short phrase
"""
...
OUT_DIR = POC_DIR / "output_steven_v5"
...
OVERRIDES = [
    ...
    {"id": 5,"speaker":"Theon",   "emotion":"defiant",         "start_ms": 22880,"end_ms": 23680,"text":"Not mine.",                     "theme":"career"},
    {"id": 6,"speaker":"Theon",   "emotion":"defiant",         "start_ms": 25080,"end_ms": 26560,"text":"I follow only me.",             "theme":"work"},
    ...
    {"id":14,"speaker":"Theon",   "emotion":"resolute-strong", "start_ms": 50920,"end_ms": 51860,"text":"I rise.",                       "theme":"identity"},
    ...
    {"id":18,"speaker":"Ramsay",  "emotion":"menacing-playful","start_ms": 68240,"end_ms": 69500,"text":"Steven rise.",                  "theme":"strength"},
    ...
    {"id":25,"speaker":"Theon",   "emotion":"contemplative",   "start_ms":159960,"end_ms":161160,"text":"She's still with you.",         "theme":"breakup"},
]
...
def main():
    t0 = time.time()
    print("="*70); print(" STEVEN x THEON v5 — volume fix + tighter text"); print("="*70)
    ...
    final_path = OUT_DIR / "steven_theon_personalized_v5.mp3"
