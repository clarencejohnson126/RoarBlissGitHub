#!/usr/bin/env python3
"""
Steven x Theon v8 — density push (target ~60% personalization)
==============================================================
Same architecture as v7 (storyline beats, name distribution, emotion variety).
This pass DENSIFIES by adding 15 new slots to fill the gaps that were left
intact in v7. 40 slots total. Steven name still said 5x (~once per 36s).
Goal: feel out the right default personalization density for the product.
"""
...
OUT_DIR = POC_DIR / "output_steven_v8"
CACHE_DIR = POC_DIR / "output_steven_v7" / "tts_cache"  # reuse v7 cache for 25 slots; 15 new will synth fresh
...
OVERRIDES = [
    # ── BEAT 1: SETUP (0-15s) ─────────────────────────────────────────────
    {"id": 1,"speaker":"Narrator","emotion":"neutral",         "start_ms":  1040,"end_ms":  2260,"text":"Meet Steven.",                       "theme":"name"},
    ...
    # ── BEAT 2: REJECTION (20-50s) ────────────────────────────────────────
    {"id": 5,"speaker":"Theon",   "emotion":"defiant",         "start_ms": 20720,"end_ms": 22740,"text":"His boss doesn't see his dreams.",   "theme":"work"},        # NEW
    {"id": 6,"speaker":"Theon",   "emotion":"defiant",         "start_ms": 22880,"end_ms": 23680,"text":"Not my world.",                      "theme":"career"},
    {"id": 7,"speaker":"Theon",   "emotion":"defiant",         "start_ms": 25080,"end_ms": 26560,"text":"I answer to no one.",                "theme":"work"},
    {"id": 8,"speaker":"Yara",    "emotion":"provoking",       "start_ms": 27560,"end_ms": 28460,"text":"Not about the past.",                "theme":"breakup"},     # NEW
    {"id": 9,"speaker":"Yara",    "emotion":"provoking",       "start_ms": 30940,"end_ms": 32880,"text":"Their cold words cannot hold him.",  "theme":"work"},
    {"id":10,"speaker":"Yara",    "emotion":"provoking",       "start_ms": 33860,"end_ms": 35540,"text":"His past has made him bold.",        "theme":"breakup"},
    {"id":11,"speaker":"Theon",   "emotion":"resolute-strong", "start_ms": 36060,"end_ms": 37480,"text":"I am Steven now.",                   "theme":"identity"},    # NAME #2
    {"id":12,"speaker":"Theon",   "emotion":"defiant",         "start_ms": 40820,"end_ms": 41780,"text":"Done with the past.",                "theme":"career"},
    {"id":13,"speaker":"Theon",   "emotion":"contemplative",   "start_ms": 42260,"end_ms": 44040,"text":"The old life weighed on him.",       "theme":"career"},
    {"id":14,"speaker":"Theon",   "emotion":"defiant",         "start_ms": 44200,"end_ms": 45120,"text":"And it's not his role.",             "theme":"work"},        # NEW
    {"id":15,"speaker":"Theon",   "emotion":"defiant",         "start_ms": 45920,"end_ms": 46720,"text":"Because it's not his world.",        "theme":"career"},      # NEW
    {"id":16,"speaker":"Theon",   "emotion":"resolute-strong", "start_ms": 47460,"end_ms": 48100,"text":"It's him.",                          "theme":"identity"},
    {"id":17,"speaker":"Theon",   "emotion":"calm-measured",   "start_ms": 48620,"end_ms": 50640,"text":"He can not live two lives.",         "theme":"crossroads"},

    # ── BEAT 3: IDENTITY REBIRTH (50-66s) ─────────────────────────────────
    {"id":18,"speaker":"Theon",   "emotion":"resolute-strong", "start_ms": 50920,"end_ms": 51860,"text":"He's reborn.",                       "theme":"identity"},
    {"id":19,"speaker":"Theon",   "emotion":"resolute-strong", "start_ms": 52540,"end_ms": 53280,"text":"He is free.",                        "theme":"identity"},
    {"id":20,"speaker":"Theon",   "emotion":"resolute-strong", "start_ms": 53280,"end_ms": 54020,"text":"He is no slave.",                    "theme":"work"},        # NEW
    {"id":21,"speaker":"Theon",   "emotion":"defiant",         "start_ms": 56080,"end_ms": 58800,"text":"A.I. is what Steven was born for.",  "theme":"career"},      # NAME #3
    {"id":22,"speaker":"Theon",   "emotion":"defiant",         "start_ms": 60740,"end_ms": 62320,"text":"He serves only his vision.",         "theme":"work"},        # NEW
    {"id":23,"speaker":"Theon",   "emotion":"resolute-strong", "start_ms": 64060,"end_ms": 65880,"text":"He'll build his own empire now.",    "theme":"vow"},
    {"id":24,"speaker":"Theon",   "emotion":"resolute-strong", "start_ms": 66100,"end_ms": 67380,"text":"Help yourself, Steven.",             "theme":"identity"},    # NEW — NAME #4

    # ── BEAT 4: THE BREAK (68-110s) — Ramsay arc densified ────────────────
    {"id":25,"speaker":"Ramsay",  "emotion":"menacing-playful","start_ms": 68240,"end_ms": 69500,"text":"Rise up now.",                       "theme":"strength"},
    {"id":26,"speaker":"Ramsay",  "emotion":"menacing-playful","start_ms": 74140,"end_ms": 76140,"text":"Which old life must he leave most.", "theme":"crossroads"},  # NEW
    {"id":27,"speaker":"Ramsay",  "emotion":"menacing-playful","start_ms": 80840,"end_ms": 82400,"text":"If fear stops you cold.",            "theme":"thailand"},
    {"id":28,"speaker":"Ramsay",  "emotion":"hard-instructional","start_ms":84920,"end_ms": 87080,"text":"Find your strength deep within.",   "theme":"gym"},
    {"id":29,"speaker":"Ramsay",  "emotion":"menacing-playful","start_ms": 87680,"end_ms": 89300,"text":"Old work was his enemy.",            "theme":"career"},      # NEW
    {"id":30,"speaker":"Ramsay",  "emotion":"menacing-playful","start_ms": 89940,"end_ms": 91500,"text":"But does he love himself yet.",      "theme":"breakup"},     # NEW
    {"id":31,"speaker":"Theon",   "emotion":"broken-whisper",  "start_ms": 98320,"end_ms": 99780,"text":"He will never give up now.",         "theme":"strength"},    # NEW
    {"id":32,"speaker":"Theon",   "emotion":"broken-whisper",  "start_ms":105660,"end_ms":107040,"text":"Who is he now?",                     "theme":"identity"},    # NEW

    # ── BEAT 5: NAME RECLAMATION (107-110s) ───────────────────────────────
    {"id":33,"speaker":"Theon",   "emotion":"broken-whisper",  "start_ms":107160,"end_ms":108060,"text":"Steven.",                            "theme":"name"},        # NAME #5 — peak

    # ── BEAT 5b: NEW IDENTITY ECHO (110-115s) ─────────────────────────────
    {"id":34,"speaker":"Theon",   "emotion":"broken-whisper",  "start_ms":110020,"end_ms":111300,"text":"Free from the past now.",            "theme":"identity"},    # NEW
    {"id":35,"speaker":"Theon",   "emotion":"broken-whisper",  "start_ms":113600,"end_ms":115440,"text":"Run toward your own dream now.",     "theme":"thailand"},    # NEW

    # ── BEAT 6: CONTEMPLATION (135-160s) ──────────────────────────────────
    {"id":36,"speaker":"Theon",   "emotion":"contemplative",   "start_ms":136220,"end_ms":139120,"text":"Thailand has always called him home.","theme":"thailand"},
    {"id":37,"speaker":"Theon",   "emotion":"calm-measured",   "start_ms":147480,"end_ms":149740,"text":"A road he was too scared to walk.",  "theme":"crossroads"},
    {"id":38,"speaker":"Theon",   "emotion":"calm-measured",   "start_ms":151840,"end_ms":152800,"text":"Stay or go?",                        "theme":"crossroads"},

    # ── BEAT 7: RESOLUTION (160-180s) ─────────────────────────────────────
    {"id":39,"speaker":"Theon",   "emotion":"contemplative",   "start_ms":159960,"end_ms":161160,"text":"She is part of him.",                "theme":"breakup"},
    {"id":40,"speaker":"Theon",   "emotion":"contemplative",   "start_ms":176120,"end_ms":178480,"text":"He's not the man he used to be.",    "theme":"identity"},    # NEW
]
...
def main():
    t0 = time.time()
    print("="*70); print(" STEVEN x THEON v8 — DENSITY PUSH (~60% personalization)"); print("="*70)
    ...
    final_path = OUT_DIR / "steven_theon_personalized_v8.mp3"
