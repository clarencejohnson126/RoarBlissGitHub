#!/usr/bin/env python3
"""
Steven x Theon v4 — 180s cap, 25 slots, natural pace
====================================================
Changes from v2/v3:
  - Source trimmed to first 180s (3 min cap per user request)
  - Speed FIXED at 1.0 (per user: "nobody talks at 1.5 speed, sounds fake")
  - Text aggressively short — target ~3 syl/sec × slot_duration so clones
    land at natural Qwen3 pace without needing time-stretch
  - 4 opening slots in 0-10s for retention/bond
  - Each slot picked to be immediately followed by same-speaker original
    speech, so clone flows into original (the v2 Jon Snow magic)
  - Phase 4: prefer cut-to-fit (shorter clone + silence under 3s cap) over stretch
"""
...
OUT_DIR = POC_DIR / "output_steven_v4"
...
# ---------------------------------------------------------------------------
OVERRIDES = [
    # ── OPENING BOND (0-15s) — early personalization for retention ────────
    ...
    # ── CAREER REJECTION (22-50s) ─────────────────────────────────────────
    {"id": 5,"speaker":"Theon",   "emotion":"defiant",         "start_ms": 22880,"end_ms": 23680,"text":"Not my place.",                 "theme":"career"},
    {"id": 6,"speaker":"Theon",   "emotion":"defiant",         "start_ms": 25080,"end_ms": 26560,"text":"I follow only me now.",         "theme":"work"},
    {"id": 7,"speaker":"Yara",    "emotion":"provoking",       "start_ms": 30940,"end_ms": 32880,"text":"Their words can not bring you down.","theme":"work"},
    {"id": 8,"speaker":"Yara",    "emotion":"provoking",       "start_ms": 33860,"end_ms": 35540,"text":"Your past has made you strong.","theme":"breakup"},
    {"id": 9,"speaker":"Theon",   "emotion":"resolute-strong", "start_ms": 36060,"end_ms": 37480,"text":"I am Steven now.",              "theme":"identity"},
    {"id":10,"speaker":"Theon",   "emotion":"defiant",         "start_ms": 40820,"end_ms": 41780,"text":"Time to change.",               "theme":"career"},
    {"id":11,"speaker":"Theon",   "emotion":"contemplative",   "start_ms": 42260,"end_ms": 44040,"text":"Old work weighed on me.",       "theme":"career"},
    {"id":12,"speaker":"Theon",   "emotion":"resolute-strong", "start_ms": 47460,"end_ms": 48100,"text":"I'm Steven.",                   "theme":"name"},
    {"id":13,"speaker":"Theon",   "emotion":"calm-measured",   "start_ms": 48620,"end_ms": 50640,"text":"Two worlds can't hold me.",     "theme":"crossroads"},

    # ── IDENTITY REBIRTH (50-66s) ─────────────────────────────────────────
    {"id":14,"speaker":"Theon",   "emotion":"resolute-strong", "start_ms": 50920,"end_ms": 51860,"text":"I'm reborn.",                   "theme":"identity"},
    {"id":15,"speaker":"Theon",   "emotion":"resolute-strong", "start_ms": 52540,"end_ms": 53280,"text":"I'm free.",                     "theme":"identity"},
    {"id":16,"speaker":"Theon",   "emotion":"defiant",         "start_ms": 56080,"end_ms": 58800,"text":"A.I. is what I was born for.",  "theme":"career"},
    {"id":17,"speaker":"Theon",   "emotion":"resolute-strong", "start_ms": 64060,"end_ms": 65880,"text":"I'll build my own future now.", "theme":"vow"},

    # ── RAMSAY ARC: BREAKING + REBUILDING (68-110s) ───────────────────────
    {"id":18,"speaker":"Ramsay",  "emotion":"menacing-playful","start_ms": 68240,"end_ms": 69500,"text":"Steven, rise up.",              "theme":"strength"},
    {"id":19,"speaker":"Ramsay",  "emotion":"menacing-playful","start_ms": 80840,"end_ms": 82400,"text":"If fear holds you back.",       "theme":"thailand"},
    {"id":20,"speaker":"Ramsay",  "emotion":"hard-instructional","start_ms":84920,"end_ms": 87080,"text":"Find your strength inside.",   "theme":"gym"},
    {"id":21,"speaker":"Theon",   "emotion":"broken-whisper",  "start_ms":107160,"end_ms":108060,"text":"I'm Steven.",                   "theme":"name"},

    # ── CROSSROADS CONTEMPLATION (135-165s) ───────────────────────────────
    {"id":22,"speaker":"Theon",   "emotion":"contemplative",   "start_ms":136220,"end_ms":139120,"text":"Thailand always called to my heart.","theme":"thailand"},
    {"id":23,"speaker":"Theon",   "emotion":"calm-measured",   "start_ms":147480,"end_ms":149740,"text":"Like there was a path I was scared to take.","theme":"crossroads"},
    {"id":24,"speaker":"Theon",   "emotion":"calm-measured",   "start_ms":151840,"end_ms":152800,"text":"Stay or leave?",                "theme":"crossroads"},
    {"id":25,"speaker":"Theon",   "emotion":"contemplative",   "start_ms":159960,"end_ms":161160,"text":"She'll always be part of you.", "theme":"breakup"},
]
...
def synthesize_clone(text, speaker, emotion, full_vocals):
    ...
    cache_key = hashlib.md5(f"v4_{speaker}_{emotion}_{text}".encode()).hexdigest()
    cache_file = CACHE_DIR / f"clone_{cache_key}.wav"
    if cache_file.exists():
        return AudioSegment.from_wav(str(cache_file)), best["emotion"]
    with open(ref_path, "rb") as f:
        ref_b64 = base64.b64encode(f.read()).decode()
    payload = {"text": text, "language":"English", "ref_audio_base64": ref_b64,
...
def main():
    t0 = time.time()
    print("="*70); print(" STEVEN x THEON v4 — 180s, 25 slots, natural pace"); print("="*70)
    ...
    for ov in OVERRIDES:
        ...
        try:
            clone, used_emo = synthesize_clone(txt, spk, emo, full_vocals)
    ...
    final_path = OUT_DIR / "steven_theon_personalized_v4.mp3"
